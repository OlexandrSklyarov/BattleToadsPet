...
namespace BT.Runtime.Data.Configs
{
    ...
    public sealed class CharacterGravityConfig : ScriptableObject
    {
        ...
        [field: Space, SerializeField] public Vector3 CheckGroundOffset {get; private set;}
        [field: SerializeField, Min(0.01f)] public float CheckGroundSphereRadius {get; private set;} = 0.2f;
