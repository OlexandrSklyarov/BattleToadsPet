...
namespace BT.Runtime.Data.Configs
{
    ...
    {          
        [field: SerializeField, Range(0.001f, 1f)] public float DefaultCrossFadeAnimation {get; private set;} = 0.01f;  
        [field: SerializeField, Range(0.001f, 0.09f)] public float AttackCrossFadeAnimation {get; private set;} = 0.01f;  
