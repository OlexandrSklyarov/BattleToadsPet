...
{
    public class HeroAttackTwoTransitionBehaviour : StateMachineBehaviour, IHeroAnimBehaviour
    {
        ...
        override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            {
                ref var animComp = ref _world.GetComponent<CharacterAttackComponent>(entity);

                if (animComp.IsExecuted || animComp.IsExecutedPower) 
                {
                    animator.Play(GameConstants.AnimatorPrm.ATTACK_3);
                }               
            }
        }
